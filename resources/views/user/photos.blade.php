...
@section('content')
    <div class="header-for-bg">
        <div class="background-header position-relative">
            <img src="{{asset('temp/images/page-img/profile-bg5.jpg')}}" class="img-fluid rounded w-100 rounded rounded" alt="profile-bg">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="user-images position-relative overflow-hidden border">
                        <a href="#">
                            <img src="{{asset('storage/'.$post->media->path)}}" class="img-fluid rounded w-100 h-100" style="max-height: 300px"  alt="Responsive image">
                        </a>
