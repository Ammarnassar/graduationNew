        ...
        <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li>
                        <a href="{{route('notifications')}}" class="iq-waves-effect"><i class="las la-bell"></i><span>Notification</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul id="mailbox" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li><a href="{{route('inbox')}}"><i class="ri-inbox-line"></i>Inbox</a></li>
                            <li><a href="{{route('send')}}"><i class="ri-edit-line"></i>Email Compose</a></li>
                        </ul>
                    </li>
                    <li>
