        ...
        <div class="sign-in-from ">
            ...
            <form class="mt-4" method="post" action="{{route('login')}}">
                ...
                <div class="d-inline-block w-100">
                    ...
                    <button type="submit"
                            class="btn btn-primary col-12 col-md-5 w-100 float-md-right">{{__('Login')}}</button>
                </div>
                <div class="sign-info">
                    <span class="dark-color d-inline-block line-height-2">{{__('Don\'t have an account?')}} <a
